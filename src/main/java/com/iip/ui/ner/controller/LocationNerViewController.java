...
//    private TableColumn TCDate;
    ...
    public void entitySelectClicked(){
        com.iip.ui.ner.controller.LocationNerViewController controller =
                (com.iip.ui.ner.controller.LocationNerViewController) com.iip.ui.ner.controller.Context.controllers.get("LocationNerViewController");
        ...
        if (selectRowIndex < 0){
            ...
            nerData.entityItems.get(selectRowIndex).locationEntityExtract();
            refreshTableData();
        }
    }
...
//        TCDate.setCellValueFactory(new PropertyValueFactory("dateStr"));
        ...
        TCEntityRes.setCellValueFactory( new PropertyValueFactory("locationEntityResult") );
    }
